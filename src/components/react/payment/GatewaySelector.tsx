...
export default function GatewaySelector({
  ...
  if (gateways.length === 0) {
    return (
      <div className="flex items-start gap-2 p-4 rounded-xl bg-[#FFCD54]/15 border border-[#FFCD54]/50">
        <svg className="w-5 h-5 text-[#142035] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
        </svg>
        <div>
          <p className="font-poppins text-sm font-semibold text-[#142035]">No hay métodos de pago disponibles</p>
          <p className="font-poppins text-xs text-[#142035] mt-0.5">Por favor llama al *34468 para ayudarte a completar la compra.</p>
        </div>
      </div>
    );
  }
